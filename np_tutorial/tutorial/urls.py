...
from .views import example_for_random, example_for_nrandom, training_for_nrandom, get_data, theory_for_random

urlpatterns = [
    path('random/theory', theory_for_random, name='random-theory'),
    path('random/example', example_for_random, name='random-example'),
    path('random/training', example_for_random, name='random-training'),
